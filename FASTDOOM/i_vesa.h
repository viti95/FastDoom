...
/* Banked scaled */
void I_FinishUpdate8bppBankedScale1x(void);
void I_FinishUpdate8bppBankedScale2x(void);
void I_FinishUpdate8bppBankedScale3x(void);
void I_FinishUpdate8bppBankedScale4x(void);
void I_FinishUpdate8bppBankedScale5x(void);
void I_FinishUpdate15bppBankedScale1x(void);
void I_FinishUpdate15bppBankedScale2x(void);
void I_FinishUpdate15bppBankedScale3x(void);
void I_FinishUpdate15bppBankedScale4x(void);
void I_FinishUpdate15bppBankedScale5x(void);
void I_FinishUpdate16bppBankedScale1x(void);
void I_FinishUpdate16bppBankedScale2x(void);
void I_FinishUpdate16bppBankedScale3x(void);
void I_FinishUpdate16bppBankedScale4x(void);
void I_FinishUpdate16bppBankedScale5x(void);
void I_FinishUpdate24bppBankedScale1x(void);
void I_FinishUpdate24bppBankedScale2x(void);
void I_FinishUpdate24bppBankedScale3x(void);
void I_FinishUpdate24bppBankedScale4x(void);
void I_FinishUpdate24bppBankedScale5x(void);
void I_FinishUpdate32bppBankedScale1x(void);
void I_FinishUpdate32bppBankedScale2x(void);
