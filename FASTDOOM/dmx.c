...
unsigned char TextSC55[] = {0x41, 0x10, 0x45, 0x12, 0x10, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
...
void MUS_TextSC55(unsigned char *text)
{
    ...
    *(sc55ptr) = MUS_ChecksumRoland(TextSC55 + 4, 19);

    MUSIC_SysEx(TextSC55, 24);
}
