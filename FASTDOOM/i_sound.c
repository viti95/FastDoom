...
{
    byte gus, adlib, adlibfx, sb, midi, ensoniq, lpt, cmsfx, cmsmus, oplxlptmus, oplxlptsnd, audiocd, rs232midi;
    int dmxlump;
    ...
    sb = snd_SfxDevice == snd_SB || snd_SfxDevice == snd_SBDirect || snd_SfxDevice == snd_AWE;
