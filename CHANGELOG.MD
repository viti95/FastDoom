...
* Optimized span rendering for Pentium, Pentium MMX, IDT WinChip, and Cyrix 6x86 CPUs in backbuffered and VBE2 direct modes
...
* Optimized backbuffer-to-VRAM copies for the Pentium MMX (first use of MMX code)
