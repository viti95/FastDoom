...
* Optimized all non-VGA modes
* Replace uncapped fps setting with new bus speed setting. Uncapped fps will come later when frame interpolation works properly. This allows to select fast or slow bus.
